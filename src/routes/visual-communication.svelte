...
<p>
    ...
    our own page. Start by putting in a line for
     the horizon and the VP’s then the front side 
     of each box. Then take the sides back to the
      vanishing points. If you get stuck draw the 
      example. Place boxes in all different locations 
...
<main class="content">
    ...
    <br />
    <p>
        Draw an accurate to scale 1x floor plan, 3 elevations and 1x perspective
        of the cabin.
    </p>
